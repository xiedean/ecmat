...
$tinybrowser['obfuscate'] = 'XKIdlke@#$34@dsfj2';

// Set default language (ISO 639-1 code)
$tinybrowser['language'] = 'zh-cn';
...
$tinybrowser['path']['image'] = '/resources/useruploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/resources/useruploads/media/'; // Media files location
$tinybrowser['path']['file']  = '/resources/useruploads/files/'; // Other files location
